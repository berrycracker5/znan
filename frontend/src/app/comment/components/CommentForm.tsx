...
import useMutationCreateComment from "@/apis/createComment";
...
import CommentRegistDialog from "./CommentRegistDialog";
import CommentRegistInfoWrapper from "./CommentRegistInfoWrapper";
...
export default function CommentForm() {
  const { mutate: createCommentMutate } = useMutationCreateComment();
  ...
  function onSubmit(data: z.infer<typeof CommentFormSchema>) {
    ...
    createCommentMutate(requestData);
    form.reset();
  }
